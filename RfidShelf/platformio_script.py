...
def html_gzip(source, target, env):
	with open('./index_template.html', 'rb') as htmlFile:
		zippedData = gzip.compress(htmlFile.read())
	
	outfile = open('./ShelfHtml.cpp', 'w', newline='\n')
	
	cCode = '// DO NOT EDIT THIS FILE! WILL BE OVERWRITTEN DURING BUILD!\n'
	cCode += '#include "ShelfHtml.h"\n\n'
	cCode += 'const uint8_t ShelfHtml::INDEX[] PROGMEM = {\n'
	...
	cCode += '\n};\n\n'
	cCode +='size_t ShelfHtml::INDEX_SIZE = ' + str(data_length) + ';'
